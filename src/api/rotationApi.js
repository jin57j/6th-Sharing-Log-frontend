...
export const rotationApi = {
  getOccurrences: (groupPublicId, params = {}) => {
    ...
    if (params.activeOn) {
      searchParams.append("activeOn", params.activeOn);
    }
    ...
    if (params.choreId) {
      searchParams.append("choreId", params.choreId);
    }
  ...
  getDueSoon: (groupPublicId) => {
    return fetchAuth(
      `/api/groups/${groupPublicId}/occurrences/due-soon`,
    );
  },
